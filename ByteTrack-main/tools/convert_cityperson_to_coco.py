...
DATA_PATH = 'D:/ByteTrack-main/datasets/Cityscapes/'
DATA_FILE_PATH = 'D:/ByteTrack-main/datasets/data_path/citypersons.train'
...
if __name__ == '__main__':
    ...
    for img_path, label_path in zip(img_paths, label_paths):
        image_cnt += 1
        im = Image.open(os.path.join("D:/ByteTrack-main/datasets", img_path))
        ...
        # Load labels
        if os.path.isfile(os.path.join("D:/ByteTrack-main/datasets", label_path)):
            labels0 = np.loadtxt(os.path.join("D:/ByteTrack-main/datasets", label_path), dtype=np.float32).reshape(-1, 6)
