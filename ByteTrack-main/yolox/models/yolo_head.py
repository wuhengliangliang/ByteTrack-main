...
class YOLOXHead(nn.Cell):
    def __init__(
        ...
        self.grids = [mindspore.ops.zeros(1)] * len(in_channels)
    ...
    def initialize_biases(self, prior_prob):
        for conv in self.cls_preds:
            ...
            conv.bias = mindspore.Parameter(b.view(-1), requires_grad=True)
    ...
    def get_l1_target(self, l1_target, gt, stride, x_shifts, y_shifts, eps=1e-8):
        ...
        l1_target[:, 2] = mindspore.log(gt[:, 2] / stride + eps)
        l1_target[:, 3] = mindspore.log(gt[:, 3] / stride + eps)
        return l1_target
    ...
    def get_assignments(
        ...
        pair_wise_ious_loss = -mindspore.log(pair_wise_ious + 1e-8)
