...
class Trainer:
    def __init__(self, exp, args):
        ...
        type_dst1 = mindspore.float16
        type_dst2 = mindspore.float32
        cast = mindspore.ops.Cast()
        out_put1 = cast(type_dst1)
        out_put2 = cast(type_dst2)
        self.data_type = out_put1 if args.fp16 else out_put2
    ...
    def before_train(self):
        ...
        # model related init
        mindspore.context.set_context(self.local_rank)
    ...
    def resume_train(self, model):
        if self.args.resume:
            ...
            ckpt = mindspore.load(ckpt_file, map_location=self.device)
            ...
            if self.args.ckpt is not None:
                ...
                ckpt_file = self.args.ckpt
                ckpt = mindspore.load(ckpt_file, map_location=self.device)["model"]
